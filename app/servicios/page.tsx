    ...
    <div>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  <svg className="w-12 h-12 text-[#0284c7] mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl font-semibold text-[#292524] mb-3">Incluye:</h3>
              ...
              <div className="bg-stone-100 p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-[#292524] mb-4">Productos destacados:</h3>
                <ul className="space-y-2 text-[#525252]">
          ...
          {/* Service 2 */}
          <div className="mb-16 bg-stone-50 p-8 rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 bg-white p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-[#292524] mb-4">Categorías disponibles:</h3>
                <ul className="space-y-2 text-[#525252]">
              ...
              <div className="order-1 md:order-2">
                ...
                <h3 className="text-xl font-semibold text-[#292524] mb-3">Beneficios:</h3>
                <ul className="space-y-2 text-[#525252]">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#0284c7] mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <Link
                  href="/importaciones"
                  className="inline-block bg-[#1a365d] text-white px-6 py-3 rounded-lg hover:bg-[#c2410c] transition"
                >
                  Conocer más sobre importaciones →
                </Link>
              </div>
              <div className="bg-stone-100 p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-[#292524] mb-4">Proceso simplificado:</h3>
                <ul className="space-y-3 text-[#525252]">
                  <li className="flex items-start">
                    <span className="font-bold text-[#0284c7] mr-2">1.</span>
                    Búsqueda y selección de proveedores
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-[#0284c7] mr-2">2.</span>
                    Negociación de precios y condiciones
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-[#0284c7] mr-2">3.</span>
                    Consolidación y control de calidad
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-[#0284c7] mr-2">4.</span>
                    Gestión logística y aduanera
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-[#0284c7] mr-2">5.</span>
