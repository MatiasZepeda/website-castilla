          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-xl font-semibold text-[#292524] mb-3">Productos destacados:</h3>
              ...
              <div className="bg-sky-50 p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-[#292524] mb-4">Ventajas para constructoras:</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-stone-50 p-8 rounded-lg">
              <div className="order-2 md:order-1 bg-white p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-[#292524] mb-4">Ventajas para oficinas:</h3>
                <ul className="space-y-3 text-[#525252]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-xl font-semibold text-[#292524] mb-3">Nuestra experiencia:</h3>
                <ul className="space-y-2 text-[#525252]">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#0284c7] mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div className="bg-sky-50 p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-[#292524] mb-4">Garantías institucionales:</h3>
                <ul className="space-y-3 text-[#525252]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-stone-50 p-8 rounded-lg">
              <div className="order-2 md:order-1 bg-white p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-[#292524] mb-4">Ventajas para retail:</h3>
                <ul className="space-y-3 text-[#525252]">
              ...
              <div className="order-1 md:order-2">
                ...
                <h3 className="text-xl font-semibold text-[#292524] mb-3">Servicios para retail:</h3>
                <ul className="space-y-2 text-[#525252]">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#0284c7] mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
