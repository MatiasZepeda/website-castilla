        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Búsqueda de proveedores</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Logística y aduana</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Entrega final</h3>
              <p className="text-gray-600 text-sm">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">Empresas Constructoras</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">PYMEs y Retail</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-blue-900 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">Instituciones Públicas</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-blue-900 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Red de proveedores verificados</h3>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Ahorro significativo</h3>
                <p className="text-gray-600">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Gestión integral</h3>
                <p className="text-gray-600">
